...
.btn-default-red {    padding: 6px 20px;}
...
.btn-default-red {margin-bottom:10px;}
}
...
<div class="content-wrapper">
  <div class="content">
      ...
      <div class="checkout-area mb-65" style="width: 100%;">
        <form method="post" action="<?php echo $base_url."billship/checkout/1" ?>" id="checkaddress">            
                 <div class="col-md-7 col-sm-12 mb-30">
                    ...
                    <?php //echo "<pre>";print_r($disti_address);echo "</pre>"; ?>                     
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="first_name" id="first_name" value="<?php echo $disti_address->first_name; echo ' '.$disti_address->last_name;?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3">Address</label>
                          <div class="col-sm-9">
                            <textarea class="form-control" rows="3" name="address1" id="address1"><?php echo $disti_address->address1; ?></textarea>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3">Landmark</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="(Optional)" name="address2" id="address2" value="<?php echo $disti_address->address2; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3">City</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="city" id="city" value="<?php echo $disti_address->city; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name="state" id="state">
                                ...
                                if($all_state !='')
                                {
                                    ...
                                    {
                                ?>
                                    <option value="<?php echo $get_state->name; ?>" <?php if($disti_address->state == $get_state->name ) { echo "selected"; } ?>><?php echo $get_state->name; ?></option>
                            <?php } } ?>
                            </select>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="post_code" id="post_code" value="<?php echo $disti_address->post_code; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="pwd">Phone</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="phone_number" id="phone_number" value="<?php echo $disti_address->phone_number; ?>">
                          </div>
                        </div>
                        <!--<div class="form-group">
                    ...
                    <div class="col-md-12" style="display:none;" id="billadd">
                      ...
                      <div  class="form-horizontal">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-3">Name</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="bill_first_name" id="bill_first_name" value="<?php echo $disti_address->bill_first_name; echo ' '.$disti_address->bill_last_name;?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3">Address</label>
                          <div class="col-sm-9">
                            <textarea class="form-control" rows="3" name="bill_address1" id="bill_address1"><?php echo $disti_address->bill_address1; ?></textarea>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3">Landmark</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="(Optional)" name="bill_address2" id="bill_address2" value="<?php echo $disti_address->bill_address2; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3">City</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="bill_city" id="bill_city" value="<?php echo $disti_address->bill_city; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3">State</label>
                          <div class="col-sm-9">
                            <select class="form-control" name="bill_state" id="bill_state">
                                ...
                                if($all_state !='')
                                {
                                    ...
                                    {
                                ?>
                                    <option value="<?php echo $get_state->name; ?>" <?php if($disti_address->bill_state == $get_state->name ) { echo "selected"; } ?>><?php echo $get_state->name; ?></option>
                            <?php } } ?>
                            </select>
                        ...
                        <!-- <div class="form-group">
                          <label class="control-label col-sm-3">Country</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="bill_country" id="bill_country" value="<?php echo $disti_address->bill_country; ?>">
                          </div>
                        </div> -->
                        <div class="form-group">
                          <label class="control-label col-sm-3">Pincode</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="bill_post_code" id="bill_post_code" value="<?php echo $disti_address->bill_post_code; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="pwd">Phone</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="bill_phone_number" id="bill_phone_number" value="<?php echo $disti_address->bill_phone_number; ?>">
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-12 text-right check-out-btn-wrap" style="margin-bottom:10px;">
                        ...
                        <div class="form-group">
                          <label class="control-label col-sm-3">&nbsp;</label>
                          <div class="col-sm-9">
                             <!--button type="button" class="btn btn-default-red" onclick="all_validation_new();" >Continue To Order <i class="fa fa-bookmark-o" aria-hidden="true"--></i></button>

                            <button type="button" class="btn btn-default-red" onclick="all_validation();" > Continue To Order <i class="fa fa-bookmark-o" aria-hidden="true"></i></button>
...
<?php
/*$str = 'BDSKUATY|BPCL-456|NA|'.$total.'|NA|NA|NA|INR|NA|R|bdskuaty|NA|NA|F|'.$this->session->userdata('city_id').'|'.$this->session->userdata('state_id').'|'.$this->session->userdata('mobile').'|'.$this->session->userdata('email').'|NA|NA|NA|NA';
...
<script>
    function all_validation_new()
        ...
        var formValues= $('#checkaddress').serialize();
       var url = '<?php echo $base_url ?>billship/checkout';
       $.post(url, formValues, function(data){
        console.log(data);
            // Display the returned data in browser
            /*bdPayment.initialize({
                msg :'BDSKUATY|BPCL-456|NA|<?php echo $total;?>|NA|NA|NA|INR|NA|R|bdskuaty|NA|NA|F|Malad|Mumbai|8097517488|patel321@gmail.com|NA|NA|NA|NA|<?php echo $checksum; ?>',
                        callbackUrl: '<?php echo $base_url."billship/success/" ?>'+data,
            options : {
            ...
            bdPayment.initialize({
                msg :'BDSKUATY|BPCL-456|NA|<?php echo $total;?>|NA|NA|NA|INR|NA|R|bdskuaty|NA|NA|F|<?php echo $this->session->userdata('city_id'); ?>|<?php echo $this->session->userdata('state_id'); ?>|<?php echo $this->session->userdata('mobile'); ?>|<?php echo $this->session->userdata('email'); ?>|NA|NA|NA|NA|<?php echo $checksum; ?>',
                        callbackUrl: '<?php echo $base_url."billship/success/" ?>'+data,
            options : {
                            enableChildWindowPosting : true,
                            enablePaymentRetry : true,
...
function all_validation()
        ...
        if(!$("#buttoncheck").is(":checked")) {                                         
            ...
            $('#checkaddress').attr('action', '<?php echo $base_url; ?>billship/checkout/' + value);
            $('#checkaddress').submit(); 
            } else {
                $("#per_validat_error").html("Please Select Payment Mode.");
                $('#per_validat_error').show().delay(0).fadeIn('show');
                $('#per_validat_error').show().delay(2000).fadeOut('show');
                return false;
            }

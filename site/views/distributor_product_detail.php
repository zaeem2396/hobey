                                    ...
                                    <div class="details font-size-18">
                                        ...
                                        <h3 class="price">
                                            <p id="price_detail_change">
                                                ...
                                                <span> DBP : <i class="fa fa-rupee"></i> <?php echo $product_details->billing_price + $product_details->deliverypay + $product_details->bpclpay; ?> <span>
                                                        <!-- <span class="strtt"><i class="fa fa-rupee"></i> 1400</span> -->
                                            </p>
                                        </h3>
                                        ...
                                        <p class="fabric" style="font-size:15px;"> <span><strong>Material Type :</strong></span>
                                            <span> <?php $cate_detaisl = $this->home_model->get_category($product_details->material_type);
                                                    echo $cate_detaisl->name;
                                                    ?> </span>
                                        </p>
                                            ...
                                            if ($relatedproduct_cat != '') {
                                                ...
                                                <li>
                                                    ...
                                                    <p class="late_pro_price">
                                                        <!-- <span><i class="fa fa-rupee"></i> 1400</span> --> <i class="fa fa-rupee"></i> <?php echo $value->bpcl_special_price; ?></p>

        ...
        <div class="row">
                        ...
                        <div class="product_list_right_main">
                            ...
                            <div class="container-fluid">
                                <div class=" page-nm">
                                    ...
                                    <!-- <i class="fa fa-angle-right"></i> &nbsp;Agri Gold Palmolein Oil -->
                                    ...
                                    if ($allproduct != '') {
                                        foreach ($allproduct as $key => $value) {
                                            ...
                                            <li>
                                                ...
                                                <p class="late_pro_price">
                                                    <!-- <span><i class="fa fa-rupee"></i> 1400</span> -->

                                                    <div> MRP: <i class="fa fa-rupee"></i> <?php echo $value->mrp; ?></div>
                                                    <div> BPCL Special Price : <i class="fa fa-rupee"></i> <?php echo $value->bpcl_special_price; ?></div>
                                                </p>
                                                <div> DBP : <i class="fa fa-rupee"></i> <?php echo $value->billing_price + $value->deliverypay + $value->bpclpay; ?></div>
                                                </p>
                                                <p>
                                                    <!-- div class="number">
        	...
        	<span class="plus">+</span>
                                                ...
                                                <div class="late_pro_btn">
                                                    <a href="javascript:void(0);" onClick="addtowishlist('<?php echo $value->id; ?>');"> <i class="fa fa-heart"></i> </a> <a href="<?php echo $base_url; ?>distribute-product-detail/<?php echo $value->page_url; ?>">View Details</a>
                                                </div>
                                            </li>
                                    <?php }
                                    } ?>

...
<div class="modal-header">
    ...
    <div class="toolbar hidden-print" style="margin-right: 35px;">
        <div class="text-right">
            ...
            <?php } ?>
            <button class="btn btn-default-red" id="btnExport" style="padding: 6px 20px;" value="Export" onclick="Export()"><i
                            ...
                            <table style="width:100%;padding-top:0px;border: 1px solid #000;">
							  ...
							  ?>
                                <tr>
                                    ...
                                    <td>Rs. <?php echo round($order->coupondiscount); ?></td>
							  ...
							  $coupondiscount = $order->coupondiscount;
                                ...
                                <tr>
                                    <td colspan="10" style="text-align:left;font-size:18px;">Amount in Words: <?php echo AmountInWords(round(($price + $shippingcost - $coupondiscount))); ?></td>
                                </tr>

                                <tr>
                                    <td colspan="10" style="text-align:right;font-size:18px;">For <strong><?php echo $vendordetails->name; ?>:</strong></td>
                                </tr>
                                <tr>

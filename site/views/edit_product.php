			...
			<div class="login" id="breadcrumb">
						     ...
						     <div class="col-md-6">
                                ...
                                <div class="col-md-6" style="display: none;">
									...
									<label>Upload Product image / Product Brochure</label>
                                        ...
                                        <img src="<?php echo $http_host;?>upload/product/<?php echo $product_image; ?>" style="width: 150px;" >
                                    </div>
                                </div>
								 <div class="col-md-6">
                                    <div class="form-group">
			  ...
			  <hr/>
				<div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <input id="billing_price" name="billing_price" type="text" required="required" class="form-control" value="<?php echo $billing_price; ?>" placeholder="Billing Price*">
                                    </div>
                                </div>
                                <div class="col-md-3" style="display: none;">
                                    <div class="form-group">
                                        <input id="orc" name="orc" type="text" required="required" class="form-control" value="<?php echo $orc; ?>" placeholder="ORC*">
                                    </div>
                                </div>
			  ...
			  <hr>
				<div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="package" name="package" type="text" required="required" class="form-control" value="<?php echo $package; ?>" placeholder="Packsize*">
                                    </div>
                                </div>
								 <!-- <div class="col-md-6">
                                    <div class="form-group">
						...
						<div class="row">
                                ...
                                <?php $allpincode = $this->home_model->show_pincode_change($addition_item[$i]->city_id); ?>
...
<script>
    ...
    if(billing_price == ''){          
        $("#error_msg1").html("Please Enter DBP (Dealer Billing price)");
        $("#validator").css("display","block");
        document.getElementById("breadcrumb").scrollIntoView(true); 
        return false;
    }
    ...
    if(package == ''){          
        $("#error_msg1").html("Please Enter Packsize");
        $("#validator").css("display","block");
        document.getElementById("breadcrumb").scrollIntoView(true); 
        return false;
    }
...
{
        var url = '<?php echo $base_url ?>/home/show_city_change/';
        $.ajax({
        url:url,
        type:'post',
...
{
        var url = '<?php echo $base_url ?>/home/show_city1_change/';
        $.ajax({
        url:url,
        type:'post',
        data:'cid='+cid+'&show_id='+show_id+'&sid=',
...
{
        var url = '<?php echo $base_url ?>/home/show_pincode1_change/';
        $.ajax({
        url:url,
        type:'post',
       data:'cid='+cid+'&show_id='+show_id+'&sid=',

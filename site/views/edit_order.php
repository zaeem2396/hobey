                                            ...
                                            <table class="table table-striped" id="productList">
                                                ...
                                                foreach ($orderList as $orders) :
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Rs. <span id="trpice_<?php echo $value->id; ?>">
                                                                <?php
                                                                    $price = $orders['product_item_price'] / $orders['product_quantity'];
                                                                    echo $price;
                                                                    ?>
                                                            </span></td>
                                                        <td>Rs. <span id="trpice_<?php echo $value->id; ?>"><?php echo $orders['realprice']; ?></span></td>
                                                        ...
                                                        <td>
                                                            <select class="form-control" name="productqty[]" oninput="this.value = Math.abs(this.value)" id="quantityb_<?= $value->id; ?>" value="0" min="1">
                                                                ...
                                                                <?php for ($i = 1; $i <= 20; $i++) : ?>
                                                                    <option value="<?= $orders['product_quantity'] ?>" <?= ($orders['product_quantity'] == $i) ? "selected" : ""; ?>><?= $i ?></option>
                                                                <?php endfor; ?>
                                                            </select>

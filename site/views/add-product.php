			  ...
			  <hr/>
				<div class="row">
								...
								<div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                        <input id="billing_price" name="billing_price" type="text" required="required" class="form-control" value="" placeholder="Billing Price*">
                                    </div>
                                </div>
                                <div class="col-md-3" style="display:none;">
                                    <div class="form-group">
                                        <input id="orc" name="orc" type="text" required="required" class="form-control" value="" placeholder="ORC*">
                                    </div>
                                </div>
						</div>		
				...
				<div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="package" name="package" type="text" required="required" class="form-control" value="" placeholder="Packsize*">
                                    </div>
                                </div>
								 <!-- <div class="col-md-6">
                                    <div class="form-group">

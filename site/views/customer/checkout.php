    ...
    <div class="row checkout-accordion">
      <div class="col-md-6 col-sm-12 col-md-3 col-md-push-9 mb-30">
        <div class="order-summary">
          ...
          <?php }
          $totalamount = ($cart_subtotal - $discountamount);
          ?>
                          ...
                          <div class="border-solid padding-15">
                            <div class="border-dotted-bottom mb-15">
                              <label class="control control--radio">
                                ...
                                <input name="address" type="radio" <?php if ($address->default_address == 1) {
                                                                          echo "checked";
                                                                        } ?> onclick="javascript:selectadd('<?php echo $address->id; ?>','<?php echo $address->post_code; ?>');">
                ...
                <div class="panel-body">
                  <div class="cart-wrap">
                    ...
                    <div class="product-cart-details">
                      ...
                      <?php $cart_subtotal += $items['subtotal'];
                        }
                      } else {

...
<div class="container">
    <div class="row mb-50 pdd50">
        ...
        <div class="col-md-12">
            <span id="register_success" class="alert-message successmain valierror123 form-group"
                style="display:none;margin-bottom: 5px;"></span>
            <div id="verticalTab">
                ...
                <div class="resp-tabs-container">
                    <div class="personal-details">
                        <form action="" method="POST" id="form_profile" enctype="multipart/form-data"
                            action="<?php echo $base_url;?>vendor-my-account">
                            <div id="error_profile" class="alert-message valierror form-group" style="display:none;"><i
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group input-group">
                                        ...
                                        <input placeholder="Full Name" class="form-control" type="text" name="fname"
                                            id="fname_pro" value="<?php echo @$profile->name; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group input-group">
                                        ...
                                        <input placeholder="Email ID" class="form-control" type="text" readonly
                                ...
                                <div class="col-md-12">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon"><i class="fa fa-mobile"
                                                aria-hidden="true"></i></span>
                                        <input placeholder="Mobile Number" class="form-control" id="mobile_pro"
                                            name="mobile" value="<?php echo @$profile->mobile; ?>" type="text">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                        <input placeholder="Location Pincode" class="form-control" type="text"
                                            id="pincode" name="pincode" value="<?php echo @$profile->pincode; ?>">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                        	<div class="form-group input-group">
                                ...
                                <div class="col-md-12">
                                    <button type="button" onClick="javascript:profile_form_vali(); return false;"
                                        class="btn btn-default-red">Save Changes <i class="fa fa-check"
                    ...
                    <div class="change-password">
                        ...
                        <form action="" method="POST" id="form_password" enctype="multipart/form-data"
                            action="<?php echo $base_url;?>vendor-my-account">
                            <div id="error_profile_password" class="alert-message valierror form-group"
                                style="display:none;"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                            </div>
                            <input type="hidden" name="action" value="update_password">
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon"><i class="fa fa-asterisk"
                                                aria-hidden="true"></i></span>
                                        <input placeholder="Current Password" name="old_password" id="old_password"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon"><i class="fa fa-asterisk"
                                                aria-hidden="true"></i></span>
                                        <input placeholder="New Password" name="pass" id="pass" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon"><i class="fa fa-asterisk"
                                                aria-hidden="true"></i></span>
                                        <input id="cpass" placeholder="Confirm Password" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-default-red"
                                        onClick="javascript:password_form_vali(); return false;">Save Changes <i
                    ...
                    ?>
                                <div class="col-md-12 clearfix">
                                    <div class="accordion-heading font-size-14">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                                            href="#collapseOne<?php echo $i; ?>">Order Number
                                            #<?php echo $order['order_id']?></a>
                                    </div>
                                    <div id="collapseOne<?php echo $i; ?>"
                                        class="accordion-body collapse <?php if($i == 0) { echo "in";  } ?>">
                                        <div class="padding-15">
                                            <div class="accordion-toggle">
                                                ...
                                                <div
                                                    class="col-xs-12 col-md-6 col-md-push-6 text-xs-center text-sm-center text-right mb-15 padding-none">
                                                    <p>
                                                ...
                                                <div
                                                    class="col-xs-12 col-md-6 col-md-pull-6 text-xs-center text-sm-center mb-15 padding-none">
                                       ...
                                       echo $mysqldate = date( 'l, F d, Y', $order_date );?></section>
                                           ...
                                           foreach ($order['items'] as $item) { ?>
                                                <div class="col-xs-12 text-xs-center padding-none">
                                                    <div
                                                        class="col-lg-2 col-md-2 col-sm-3 col-xs-12 mb-15 text-xs-center padding-none">
                                                        <?php
                                                if($item['base_image'] !=''){ ?>
                                                        <img
                                                            src="<?php echo $http_host; ?>upload/product/<?php echo $item['base_image']; ?>">
                                                        <?php } else { ?>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-9 col-xs-12">
                                                        ...
                                                        <section class="mb-5">Discount - <i
                                                                class="fa fa-inr"></i><?= $order['coupondiscount']; ?>
                                                        </section>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-9 col-xs-12 mb-15"
                                                        style="display: block;">
                                                ...
                                                <div class="col-xs-12 padding-10 text-center bg-red font-size-20 mb-30">
                                                    <i class="fa fa-minus" aria-hidden="true"></i> Total <i
                                                        class="fa fa-inr"></i>
                                                    <?php echo number_format($order['order_total']);?> <i
                                ...
                                <?php $i++; } } else { echo "Order Not found"; } ?>
                            </div>
                        </div>
                    </div>
                ...
                ?>
                                ...
                                <div class="border-solid padding-15">
                                    <div class="border-dotted-bottom mb-15">
                                        <label class="control control--radio">
                                            ...
                                            <input name="address" <?php if($get_addres->default_address == '1') {  ?>
                                                checked="" <?php } ?> type="radio"
                                                onclick="defaultaddress('<?php echo $base_url."account/defaultaddress/"; ?><?php echo $get_addres->id ?>');return false;">
                                    ...
                                    <div>
                                        ...
                                        <p class="add-trash-icon clearfix">
                                            <span class="pull-left"><a
                                                    href="<?php $base_url; ?>account/edit_address/<?php echo $get_addres->id; ?>"><i
                                                        class="fa fa-pencil" aria-hidden="true"></i></a></span>
                                            <span class="pull-right"><a href="javascript:void(0);"
                                                    onclick="deleteaddress('<?php echo $base_url."account/removeadd/"; ?><?php echo $get_addres->id ?>');return false;"><i
                        ...
                        <div class="row">
                            <div class="col-sm-12 mb-30"> <a class="add-address-btn" data-toggle="collapse"
                                    data-target="#newShippingAddress"><i class="fa fa-plus" aria-hidden="true"></i> Add
                                    New Address</a> </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="collapse" id="newShippingAddress">
                                <div class="col-md-12">
                                    ...
                                    <form class="form-horizontal" action="<?php echo $base_url; ?>customer-my-account"
                                        id="form_address_add" name="form_address_add" method="POST">
                            ...
                            <input type="text" class="form-control" id="address_title" name="address_title">
                                ...
                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div id="error_checkout"
                                                    class="error alert-message valierror form-control"
                                                    style="display:none;color:#fff;"></div>
                                                <button type="button" onclick="saveAddress();"
                                                    class="btn btn-default-red">Save and Continue <i
                    ...
                    <div class="my-wishlist text-xs-center text-sm-center">
                        ...
                        <div class="row border-solid-bottom padding-bottom-15 padding-top-15">
                            ...
                            <div class="col-md-4 mrg-bot-15"><a href="javascript:void(0);"
                                    onClick="delete_wishlist('<?php echo $base_url."account/delete_wishlist/"; ?><?php echo $item->wish_id ?>');return false;">Remove
                                    from wishlist</a></div>

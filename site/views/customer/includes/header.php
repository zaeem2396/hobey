...
@media (max-width: 767px) {
    ...
    .top-content{  padding: 18px 0px 38px 0px;}
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-3 col-xs-3 text-xs-left">
        ...
        <span class="hidden-xs" style="    display: inherit;"><i class="fa fa-map-marker" aria-hidden="true" style="font-size: 24px;"></i>  <span>Deliver to </span> <?php echo $this->session->userdata('check_pincode');?> &nbsp;<a href="javascript:void(0);" id="OpenPincodeModal"><i class="fa fa-edit"></i> </a></span> </div>
         ...
         <div class="sp-icon">
           <div class="inline-block"> 
            ...
            <div class="inline-block"> 
             ...
             <a href="<?php echo $base_url; ?>customer-cart"><div class="shopping_cart" title="Viewcart"><i class="fa fa-shopping-cart" aria-hidden="true"></i> </div> </a>
            </div>
            <div class="inline-block"> 
            
             <a href="#"><div class="shopping_cart" title="Wishlist"> <i class="fa fa-heart" aria-hidden="true"></i></div> </a>
            </div>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en' ,includedLanguages: 'hi,mr',  }, 'google_translate_element');
}
</script>

	...
	<div class="cart-wrap pdd50">
    	   ...
    	   <div class="row mb-15">
        		<div class="col-md-12">
        		    ...
        		    <?php if($id==0){ ?>
					   Your order has been failed. <br/> please <a href="<?php echo $this->config->item('base_url');?>customer-checkout" >Click Here</a> to do transaction again.
					<?php }else{ ?>
						<p>Your Order Has been Confirmed. Your Order Number: <?php echo $id; ?> </p>
				  <?php	} ?> 

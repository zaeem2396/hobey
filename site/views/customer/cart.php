...
<div class="container">
    <div class="cart-wrap pdd50">
        ...
        <div class="row mb-15">
            <div class="col-md-4">
                <h4>My Shopping Bag ( <?php echo count($this->cart->contents()); ?> Items)</h4>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 col-sm-2 col-xs-12 mb-15">
                                <select class="form-control cart-qty-input qty_<?php echo $items['rowid']; ?>" id="sel1" onchange="changeqty('<?php echo $items['rowid']; ?>',this.value,<?php echo $items['id']; ?>,<?php echo $items['options']['distributor_id']; ?>,<?php echo $items['qty']; ?>);">
                                    <option value="1" <?php if ($items['qty'] == '1') {
                                                                    echo "selected";
                                                                } ?>>1</option>
                                    <option value="2" <?php if ($items['qty'] == '2') {
                                                                    echo "selected";
                                                                } ?>>2</option>
                                    <option value="3" <?php if ($items['qty'] == '3') {
                                                                    echo "selected";
                                                                } ?>>3</option>
                                    <option value="4" <?php if ($items['qty'] == '4') {
                                                                    echo "selected";
                                                                } ?>>4</option>
                                    <option value="5" <?php if ($items['qty'] == '5') {
                                                                    echo "selected";
                                                                } ?>>5</option>
                                </select>
                            </div>

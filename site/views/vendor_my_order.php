...
<form action="<?php echo $base_url."vendor/download_vendororder";?>" method="post" enctype="multipart/form-data">
               <input type="hidden" value="<?php echo $this->session->userdata('userid'); ?>" id="vendor_id1" name="vendor_id">	
                                    ...
                                    <div class="padding-15">
                                      <div class="accordion-toggle">
                                       ...
                                       echo $mysqldate = date( 'l, F d, Y', $order_date );?></section>
                                          ...
                                          <div class="col-xs-12 text-xs-center padding-none">
                                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 mb-15 text-xs-center padding-none"> 
                                                <?php
                                                   ...
                                                   $billingPrice = $this->vendor_model->getBillingPrice($item['product_id']);
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-9 col-xs-12">
                                              ...
                                              <section class="">Item Price - <?php echo $billingPrice; ?></section>
                                              <?php $totalOrder = $billingPrice*$packsize1*$item['product_quantity']; ?>
                                            ...
                                            <section class="font-size-18 "> <b>Order Status : </b>
                                                    ...
                                                    {
                                                         echo "Received by Distributor";
                                                    }
                                                    ?>
                                                    
                                                </section>
                                            <!-- <form action="<?php echo $base_url."vendor/changeStatusmail/".$item['order_item_id'].$item['order_id'];?>" method="post" enctype="multipart/form-data" id="statusupdate"> -->
                                            <?php if($item['order_status'] != 'D' AND $item['order_status'] != 'R') { ?>
                                          ...
                                          <div class="col-xs-12 padding-10 text-center bg-red font-size-20 mb-30"> <i class="fa fa-minus" aria-hidden="true"></i> Total <i class="fa fa-inr"></i> <?php echo number_format($orderTotal);?> <i class="fa fa-minus" aria-hidden="true"></i> </div>
                                      </div>
                                    </div>
                                </div>                        	
                            </div>
...
<script>
    function change_order_status(status,order_item_id,orderid,oldVlaue)
    {
        ...
        if(conf==true){
        var base_url = '<?php echo $base_url.'vendor/changeStatusmail'; ?>';

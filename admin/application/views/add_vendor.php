   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-active"><a href="javascript:void(0);"> Add Vendor </a></li>
         </ol>
      </div>
   </div>
   <div id="content">
      <div class="row" id="subform">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Add Vendor</span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12">
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>vendor/add" enctype="multipart/form-data" >
                        ...
                        <!-- <div class="col-md-6">  
                            <div class="form-group">
                               <label style="width:100%; margin:15px 0 5px;" for="name">Pincode</label>
                               <input name="pincode" id="pincode" type="text" class="form-control" placeholder="Enter Pincode" value="<?php //echo $pincode; ?>" >
                                <span id="pincodenameerror" class="valierror"></span>
                            </div>
                        </div> -->

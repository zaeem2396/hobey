    ...
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          ...
          <li class="crumb-trail">Vendor</li>
          <li class="crumb-active"><a href="javascript:void(0);">Vendor</a></li>
        </ol>
      </div>
    </div>
    <div id="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <a href="<?php echo $base_url; ?>vendor/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Vendor</a>

          <a style="margin:0px 14px 0 0;" class="btn bg-purple2 pull-right" href="<?php echo $base_url; ?>vendor/xlsuploadvendor/">
            <i class="fa fa-plus"></i> Upload Vendor
          </a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Vendor Listing </span> </div>
            <div class="panel-body">
              <form action="<?php echo $base_url . "vendor/deletes"; ?>" method="post" enctype="multipart/form-data" id="form">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Mobile </th>
                        <th>Status</th>
                        <!--<th>Address Pickup Points</th>
					  <th>Razor Pay Account Id</th> -->
                        ...
                        for ($i = 0; $i < count($result); $i++) {
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <select title="Approve" id="change_status_<?php echo $result[$i]['id']; ?>" onchange="javascript:approve('<?php echo $base_url . "vendor/updatestatus/"; ?><?php echo $result[$i]['id']; ?>',this.value,<?php echo $result[$i]['status']; ?>,<?php echo $result[$i]['id']; ?>);">
                                <option value="0" <?php if ($result[$i]['status'] == 0) {
                                                        echo "selected";
                                                      } ?>>Active</option>

                                <option value="1" <?php if ($result[$i]['status'] == 1) {
                                                        echo "selected";
                                                      } ?>>Deactive</option>
                              </select>

                            </td>
                            <td class="text-center"><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url . "vendor/edit/"; ?><?php echo $result[$i]['id']; ?>">
...
<script>
  function approve(url, is_active, oldVlaue, orderid) {
    ...
    if (is_active == '0') {
      var t = confirm('Are you sure you want to Active Vendor ?');
    } else {
      var t = confirm('Are you sure you want to Deactive Vendor  ?');
    }

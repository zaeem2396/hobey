   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-link"><a href="<?php echo $base_url; ?>area/lists">Area</a></li>
            <li class="crumb-active"><a href="javascript:void(0);"> Edit Area </a></li>
         </ol>
      </div>
   </div>
   <div id="content">
      <div class="row" id="subform">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Area</span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12">
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>area/edit/<?php echo $id; ?>" enctype="multipart/form-data" >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                               <label style="width:100%; margin:15px 0 5px;" for="name">Area Name <span color="red">*</span></label>
                               <input id="name" name="name" type="text" class="form-control" placeholder="Enter Area Name" value="<?php echo $name; ?>"/>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                               ...
                               <a href="<?php echo $base_url;?>area/lists" class="submit btn btn-danger pull-right" style="margin-right: 10px;" />Cancel</a>
                            </div>
                        </div>
                    </form>
                  </div>
...
<script>
	...
	var state_id = $("#state_id").val();
        ...
        if(city_id == ''){
            $("#catnameerror").html("Please Select City");
            jQuery('#catnameerror').show().delay(0).fadeIn('show');
            jQuery('#catnameerror').show().delay(2000).fadeOut('show');
            document.getElementById("subform").scrollIntoView(true); 
            return false;
        ...
        if(sub_name == ''){
            ...
            $("#subcatnameerror").html("Please Enter Area");
...
{		var sid='<?php echo $category_id; ?>';	
		var url = '<?php echo $base_url ?>/area/show_city/';
		$.ajax({
		url:url,
		type:'post',

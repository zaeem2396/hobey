...
<section id="content_wrapper">
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-active"><a href="javascript:void(0);"> Edit Distributor </a></li>
         </ol>
      </div>
   </div>
   <div id="content">
   <div class="row" id="subform">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Distributor</span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12">
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>distributor/edit/<?php echo $id; ?>" enctype="multipart/form-data" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                               ...
                               <option value="" >-- Select Pincode --</option>
                                  <?php 
                                  $pincode_select = explode(',',$pincode);
                                  for($i=0;$i<count($allpincode);$i++)
                                     {
                                     ?>
                                  <option value='<?php echo $allpincode[$i]->id; ?>' <?php if(in_array($allpincode[$i]->name,$pincode_select)) { echo "selected"; } ?>>
                                     <?php echo $allpincode[$i]->name; ?>
                                  </option>
                                  <?php
                                     }
                                     ?>
                            ...
                            <div class="form-group">
                               <label style="width:100%; margin:15px 0 5px;" for="contact_title">Title <span style="color:red">*<span>
                                ...
                                <select id="contact_title" name="contact_title"  class="form-control jobtext">
                                    ...
                                    <option value="Mr."  <?php if($contact_title == 'Mr.') { echo "selected"; } ?>>Mr.</option>
                                    <option value="Miss" <?php if($contact_title == 'Miss') { echo "selected"; } ?>>Miss</option>
                                    <option value="Mrs" <?php if($contact_title == 'Mrs') { echo "selected"; } ?>>Mrs</option>
                                </select>

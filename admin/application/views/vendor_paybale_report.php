   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
           ...
           <li class="crumb-active"><a href="#">Vendor Paybale Report</a></li>
         </ol>
      </div>
   </div>
   <div id="content">
      <div class="row">
         ...
         <?php }  ?>
         <div class="col-md-12">
            <form action="<?php echo $base_url."reports_management/download_vpaybale";?>" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Vendor Paybale Report</span> </div>
                     ...
                     <div class="table-responsive vendorsales-scroll">
                        <table id="example1" class="table table-bordered table-striped">
                           <thead>
                              <tr>
                                 <th>Vendor Name</th>
								         <th>Amount Payabale to vendor (Rs)</th>
                              </tr>
                           </thead>
                           <tbody>
                              <?php
                                 ...
                                 ?>
                              <tr>
                              <td style="text-align:left"><?php echo $vendorlist->name; ?></td>

            ...
            <div class="panel">
              ...
              <div class="panel-body">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <select id="vendors" name="vendors" class="form-control jobtext">
                      ...
                      for ($i = 0; $i < count($vendor); $i++) {
                        ?>
                        <option value="<?php echo $vendor[$i]->id; ?>" <?php if ($vendor[$i]->id == $vendors) {
                                                                            echo "selected";
                                                                          } ?>>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <select id="categorys" name="categorys" class="form-control jobtext">
                      ...
                      for ($i = 0; $i < count($allcategory); $i++) {
                        ?>
                        <option value="<?php echo $allcategory[$i]->id; ?>" <?php if ($allcategory[$i]->id == $categorys) {
                                                                                echo "selected";
                                                                              } ?>>
                ...
                for ($i = 0; $i < count($subcategory); $i++) {
                  ?>
                <option 
                value="<?php echo $subcategory[$i]->id; ?>" <?php if ($subcategory[$i]->id == $sub_category) {
                                                                echo "selected";
                                                              } ?> >
                      ...
                      <?php if ($result) {
                        for ($i = 0; $i < count($result); $i++) { ?>
                          <tr>
                            ...
                            <!-- <td><?php //echo $this->product_model->get_subcate_name($result[$i]['subcatefory_id']); 
                                          ?></td>-->

                            <td>
                              <input type="checkbox" id="featured" name="featured" value="1" onclick="featured_product('<?php echo $result[$i]['id']; ?>',this);" <?php if ($result[$i]['featured'] == '1') {
                                                                                                                                                                        echo "checked";
                                                                                                                                                                      } ?>></td>

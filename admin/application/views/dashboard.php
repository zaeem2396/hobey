...
<?php include('include/header.php');?><!-- Start: Main --><div id="main"> 
   <?php include('include/sidebar_left.php');?>  <!-- Start: Content -->  
            ...
            <div class="panel panel-default" style="box-shadow:none">
               <div class="panel-heading">
                  ...
                  <div class="noti_a">
                     ...
                     <div><?php if($notifications != '') { echo count($notifications); } else { echo "0"; }  ?></div>
                  </div>
               </div>
            </div>

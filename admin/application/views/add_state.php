  ...
  <section id="content_wrapper">
   ...
   <div id="content">
      <div class="row">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Add State </span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12">
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>state/add" enctype="multipart/form-data">
                        <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                        <INPUT TYPE="hidden" NAME="action" VALUE="add_state">
                            
                            
                                <div class="form-group">
                                   <label  for="name">State <span color="red">*</span></label>
                                   <input id="name" name="name" type="text" class="form-control" placeholder="Enter State" value=""/>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                   ...
                                   <a href="<?php echo $base_url;?>state/lists" class="submit btn btn-danger pull-right" style="margin-right: 10px;" />Cancel</a>
                                </div>
                            </div>
...
<script>
	function validate(){
		 ...
		 var name = $("#name").val();
     if(name == ''){
   		$("#catnameerror").html("Please Enter State");

   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-icon"><a href="<?php echo $base_url; ?>orders/lists">Order Management</a></li>
      ...
      <div class="row">
         <div class="col-md-12">
                           ...
                           <div class="row">
                              <div class="col-xs-6">
                                 <address>
                                    ...
                                    <?php echo $order['country']."-".$order['post_code'].",<br>";?>
                                    ...
                                    <table class="table table-condensed">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td class="text-center"><?php echo $order['last_name'];?></td>
                              ...
                              <div class="panel-body">
                                 <div class="table-responsive">
                                    <table class="table table-condensed">
                                       <thead>
                                          <tr>
                                             <td class="thick-line-bottom"><strong>Product Image</strong></td>
                                             <td class="thick-line-bottom"><strong>Product Name</strong></td>
                                             <!-- <?php  if ($order['is_customer'] == 0){ ?>
                                             <td class="thick-line-bottom"><strong>Vendor Name</strong></td>
                                             <?php }?> -->
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td class="text-left">
                                                <?php
                                                   //$img= $this->orders_model->product_image($item['product_id']);
                                                    $img = $item['base_image'];
                                                    if($img !=''){ ?>
                                                <img src="<?php echo $front_base_url; ?>upload/product/<?php echo $img; ?>" style="max-width:150px" alt="">
                                                <?php } else { ?>
                                                <img src="<?php echo $base_url_views; ?>images/noimage.jpg" style="margin-left: 10px; height: 45px;" >
                                                <?php }  ?>
                                             </td>
                                             ...
                                             <!-- <?php  if ($order['is_customer'] == 0){ ?>
                                             <td class="text-left"><?php echo $this->orders_model->getUsername($item['vendor_id']); ?></td>
                                             <?php }?> -->
                                             ...
                                             <?php }?>
                                             <?php  if ($order['is_customer'] == 1){ ?>
                                             <td class="text-left">Rs. <?php 
                                             $mrp = $item['realprice'];
                                             $savings = $mrp-number_format($item['product_item_price']);
                                             echo $mrp;
                                              ?>
                                             </td>
                                             <td class="text-left">Rs. <?php echo $savings; ?></td>
                                             <?php }?>
                                          ...
                                          <tr>
                                             ...
                                             <td class="thick-line"></td>
                                             <td class="thick-line"></td>
                                             <td colspan="2" class="thick-line text-left"><strong>Subtotal</strong></td>
                                             <td colspan="2" class="thick-line text-right">Rs. <?php echo number_format($order['sub_total']);?></td>
                                             <td class="thick-line"></td>
                                          </tr>
                                          <!--<tr>
                                             <td class="no-line"></td>
                                          ...
                                          <tr>
                                             ...
                                             <td class="no-line"></td>
                                             <td class="no-line"></td>
                                             <td colspan="2" class="no-line text-left"><strong>Coupon Discount</strong></td>
                                             <td colspan="2" class="no-line text-right">Rs. <?php echo "-".number_format($order['coupondiscount']); ?></td>
                                             <td class="no-line"></td>
                                          </tr>
                                          <?php } ?>
                                          ...
                                          <tr>
                                             ...
                                             <td class="no-line"></td>
                                             <td class="no-line"></td>
                                             <td colspan="2" class="no-line text-left"><strong>Shipping</strong></td>
                                             <td colspan="2" class="no-line text-right">Rs.<?php echo number_format($order['shippingcost']); ?></td>
                                             <td class="no-line"></td>
                                          </tr>
                                          <?php } ?>
                                          <!-- 
                                          ...
                                          <tr>
                                             ...
                                             <td colspan="2" class="no-line text-right">Rs. <?php echo number_format($order['order_total']);?></td>
                                             <td class="no-line"></td>
                                          </tr>
                                       </tbody>
                                    </table>
            ...
            <style>
               ...
               .border-1px{border:1px solid #d5d5d5;}
               .border-bottom-1px{ border-bottom:1px solid #d5d5d5;}
               .border-left-1px{ border-left:1px solid #d5d5d5;}
               .border-right-1px{ border-right:1px solid #d5d5d5;}
               .invoice-title h2, .invoice-title h3 {
               display: inline-block;
               }
               .table > tbody > tr > .no-line {
...
function createinvoice(id) {
    var itemid = id;
    var url = '<?php echo $front_base_url; ?>index.php/home/createinvoice_vendor';
    jQuery.ajax({
        url: url,
        type: 'post',
        data: 'itemid=' + itemid,
...
function createinvoice1(id) {
    var itemid = id;
    var url = '<?php echo $front_base_url; ?>index.php/home/createinvoice';
    jQuery.ajax({
        url: url,
        type: 'post',
        data: 'itemid=' + itemid,
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed">
							...
							<?php $totalquty='0';foreach ($order['items'] as $item) { ?>
                                ...
                                <tr>
                                    <td><?php echo $item['order_item_name'];?> | <?php echo $item['order_item_code'];?></td>    <td class="highrow"></td>
                                    <td class="highrow"></td>
                                    <td class="text-center"><?php echo $item['product_quantity']; ?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="form-horizontal" role="form" id="add_tracking_info_form">
                   ...
                   <input type="hidden" class="form-control" name="id" value="<?php if (isset($tracking_info['id']) and $tracking_info['id'] != null) { echo $tracking_info['id'];}?>"/>
                  <div class="form-group">
                    <label  class="col-sm-2 control-label" for="tracking_id">Tracking ID</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?php if (isset($tracking_info['tracking_id']) and $tracking_info['tracking_id'] != null) { echo $tracking_info['tracking_id'];}?>" id="tracking_id" name="tracking_id"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly class="form-control" value="<?php if (isset($tracking_info['dispach_date']) and $tracking_info['dispach_date'] != null) { echo $tracking_info['dispach_date'];}?>" id="dispach_date" name="dispach_date"/>
                    </div>
                  </div>
                  <?php }?>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tracking_link" name="tracking_link" value="<?php if (isset($tracking_info['tracking_link']) and $tracking_info['tracking_link'] != null) { echo $tracking_info['tracking_link'];}?>"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label  class="col-sm-2 control-label" for="last_guideline">Last Guideline</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="last_guideline" name="last_guideline" value="<?php if (isset($tracking_info['last_guideline']) and $tracking_info['last_guideline'] != null) { echo $tracking_info['last_guideline'];}?>"/>
                    </div>
                  </div>
                </form>
            </div>

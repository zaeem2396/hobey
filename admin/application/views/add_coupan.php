   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-active"><a href="javascript:void(0);">Add Coupon</a></li>
         </ol>
      </div>
   </div>
   <div id="content">
      <div class="row">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Add Coupan </span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12">
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>coupan/add" enctype="multipart/form-data">
                        <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                        <INPUT TYPE="hidden" NAME="action" VALUE="add_coupan">
                        <div class="col-md-4">
                            <div class="form-group">
                               <label for="coupanname">Coupon Name</label>
                               <input id="coupanname" name="coupanname" type="text" class="form-control" placeholder="Enter Coupon Name"  />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                               ...
                               <input id="coupancode" name="coupancode" type="text" class="form-control" placeholder="Enter Coupon Code"  />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                               ...
                               <input id="discount" name="discount" type="text" class="form-control" placeholder="Enter Discount" onkeypress="return numbersonly(event)" />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                               ...
                               <input type="radio"value="0" checked  name="coupanvalue" id="coupanvalue" class="">&nbsp; Percentage &nbsp;&nbsp;
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                           ...
                           <div class="col-md-12">
                                <div class="form-group">
                                   ...
                                   <textarea id="desc" name="description" class="form-control" placeholder="Enter Short Description"></textarea>
                                </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
		...
		<script>
			...
			$('#grid2').mediaBoxes({
				...
				$('.rfa_multiple_select .fs-wrap').addClass('');
						...
						<script>function hideshow(value){	if(value==2 || value==0)	{		$('#events_id').show();		}else{		$('#events_id').hide();	}}</script>
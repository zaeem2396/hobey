    ...
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          ...
          <li class="crumb-active"><a href="javascript:void(0);">Area</a></li>
        </ol>
      </div>
    </div>
    <div id="content">
...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<a href="<?php echo $base_url;?>area/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Area</a>
		</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Area Listing </span> </div>
            <div class="panel-body">
			  <form action="<?php echo $base_url."area/deletes";?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <div class="table-responsive">
				...
				<tr>
					...
					<td style="text-align:left"><?php echo $this->area_model->get_state_name($result[$i]->state_id); ?></td>
					<td style="text-align:left"><?php echo $this->area_model->get_city_name($result[$i]->city_id); ?></td>		
					<td style="text-align:left"><?php echo $result[$i]->name; ?></td>				
					<td class="text-center"><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."area/edit/"; ?><?php echo $result[$i]->id; ?>">

   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-active"><a href="javascript:void(0);"> Add District</a></li>
         </ol>
      </div>
   </div>
   <div id="content">
      <div class="row" id="subform">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Add District </span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12" >
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>city/add" enctype="multipart/form-data">
                        ...
                        <INPUT TYPE="hidden" NAME="action" VALUE="add_category">
                            ...
                            <div class="form-group">
                               ...
                               <input id="name" name="name" type="text" class="form-control" placeholder="Enter District Name" value=""/>

    ...
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          ...
          <li class="crumb-trail">Distributor</li>
		  <li class="crumb-active"><a href="javascript:void(0);">Distributor</a></li>
        </ol>
      </div>
    </div>
    <div id="content">
...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<a href="<?php echo $base_url;?>distributor/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Distributor</a> 

      <a style="margin:0px 14px 0 0;" class="btn bg-purple2 pull-right"
                        href="<?php echo $base_url; ?>distributor/xlsuploaddistributor/">
                        <i class="fa fa-plus"></i> Upload Distributor
                    </a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Distributor Listing </span> </div>
            <div class="panel-body">
			  <form action="<?php echo $base_url."distributor/deletes";?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <div class="table-responsive">
                ...
                <tr>
					...
					<select title="Approve" id="change_status_<?php echo $result[$i]['id']; ?>" onchange="javascript:approve('<?php echo $base_url."distributor/updatestatus/"; ?><?php echo $result[$i]['id']; ?>',this.value,<?php echo $result[$i]['status']; ?>,<?php echo $result[$i]['id']; ?>);" >
                     ...
                     <td class="text-center"><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."distributor/edit/"; ?><?php echo $result[$i]['id'];?>">
...
function approve(url,is_active,oldVlaue,orderid){
  var box = document.getElementById('change_status_'+orderid);
		if(is_active=='0'){
		var t = confirm('Are you sure you want to Active Distributor ?');	
			}
		else
		{
		var t = confirm('Are you sure you want to Deactive Distributor  ?');
				}

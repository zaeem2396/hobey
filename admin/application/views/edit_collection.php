								...
								<label for="state_id">Select State</label>
                                  <select id="state_id" name="state_id" class="form-control" onchange="get_group(this.value);">
                                    ...
                                    <?php if($allstate !='')
                                    {
                                        ...
                                        { ?>
                                    		<option value="<?php echo $stateshow->id; ?>" <?php if($state_id == $stateshow->id ) { echo "selected"; } ?>><?php echo $stateshow->name; ?></option>
                                    <?php } } ?>
                                  </select>
                             </div>
                         </div>
								...
								<label for="pincode_id">Select Pincode</label>
                                  <select id="pincode_id" name="pincode_id" class="form-control">
                                    ...
                                    <?php if($allPincode !='')
                                    {
                                        ...
                                        { ?>
                                    		<option value="<?php echo $pincodeshow->id; ?>" <?php if($pincode_id == $pincodeshow->id ) { echo "selected"; } ?>><?php echo $pincodeshow->name; ?></option>
                                    <?php } } ?>
                                  </select>
                             </div>
                         </div> -->
						 ...
						 <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            foreach($allcproducts as $cproducts){ ?>
													...
													<?php if(in_array($cproducts->id,$in_product_id)){ echo "selected";} ?>>

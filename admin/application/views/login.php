...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo $base_url_views; ?>images/fevicons.ico">
...
<body class="minimal login-page imges_bodusss" style="position:relative">
  ...
  <div id="main">
    <div id="content">
      <div class="row">
        <div id="page-logo">
          <!--img src="<?php echo $base_url_views; ?>images/logo.jpg" class="img-responsive" alt="logo" style="margin-left: 32px;"-->
        </div>
      </div>
      <div class="row">
        <div class="panel-bg">
          <div class="panel">
            <form class="form" id="loginform" method="post" action="<?php echo $base_url; ?>welcome/login">
              ...
              <div class="panel-footer text-center">
                <!--<span class="text-muted fs12 lh30"><a> Forgotten Password?</a></span> -->

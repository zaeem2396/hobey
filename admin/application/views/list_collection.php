    ...
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          ...
          <li class="crumb-trail">Collection</li>
		  <li class="crumb-active"><a href="javascript:void(0);">Collection</a></li>
        </ol>
      </div>
    </div>
    <div id="content">
...
<?php if($this->session->flashdata('L_strErrorMessage')) 
		...
		<a href="javascript:void('0');" onclick="deletecountry();" class="btn btn-danger pull-right"  style="margin-left:10px"><i class="fa fa-trash-o"></i> Delete</a>
			<a href="<?php echo $base_url;?>collection/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Collection</a>
		</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Collection Listing </span> </div>
            <div class="panel-body">
			  <form action="<?php echo $base_url."collection/deletes";?>" method="post" enctype="multipart/form-data" id="form">
         ...
         <tr>
					<td><input name="selected[]" id="selected[]" value="<?php echo $result[$i]['id']; ?>" type="checkbox"  class="minimal-red"></td>
                          ...
                          <td><?php $strtotimeed =strtotime( $result[$i]['end_date'] );
							...
							<td>
					<select title="Approve" id="change_status_<?php echo $result[$i]['id']; ?>" onchange="javascript:approve('<?php echo $base_url."collection/updatestatus/"; ?><?php echo $result[$i]['id']; ?>',this.value,<?php echo $result[$i]['enabled']; ?>,<?php echo $result[$i]['id']; ?>);" >
                        ...
                        <td><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."collection/edit/"; ?><?php echo $result[$i]['id'];?>">
...
function approve(url,is_active,oldVlaue,orderid){
  var box = document.getElementById('change_status_'+orderid);
		if(is_active=='0'){
		var t = confirm('Are you sure you want to Active Collection ?');	
			}
		else
		{
		var t = confirm('Are you sure you want to Deactive Collection  ?');
				}

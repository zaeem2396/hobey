      ...
      <div id="content">
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <a href="<?php echo $base_url; ?>state/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add State</a>
            </div>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="panel">
                  <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> State Listing </span> </div>
                  <div class="panel-body">
                     <form action="<?php echo $base_url . "state/deletes"; ?>" method="post" enctype="multipart/form-data" id="form">
                                 ...
                                 if ($result) {
                                    for ($i = 0; $i < count($result); $i++) {
                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center"><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url . "state/edit/"; ?><?php echo $result[$i]->id; ?>">

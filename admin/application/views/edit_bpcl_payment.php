   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-active"><a href="javascript:void(0);"> Edit BPCL Payment <?php echo $name;?></a></li>
         </ol>
      </div>
   </div>
   <div id="content">
      <div class="row">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit BPCL Payment <?php echo $name;?> </span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12">
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>bpcl_payment/edit/<?php echo $id; ?>" enctype="multipart/form-data" >
                        <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                        <INPUT TYPE="hidden" NAME="action" VALUE="edit_bpcl_payment">
                        ...
                        <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="user_vendor" name="user_vendor" class="form-control" onchange="get_group(this.value);">
                                       ...
                                       <option value="1" <?php if($user_vendor == 1 ) { echo "selected"; } ?>>Vendor</option>
                                       <option value="2" <?php if($user_vendor == 2 ) { echo "selected"; } ?>>Distributor</option>
                                       <option value="3" <?php if($user_vendor == 3 ) { echo "selected"; } ?>>Deliveryman</option>
                                    </select>
                                ...
                                <div class="form-group">
                                 ...
                                 <label for="user_id">Select User</label>
                                          ...
                                          <?php if($allusers !='')
                                          {
                                             ...
                                             { ?>
                                                <option value="<?php echo $user->id; ?>" <?php if($user_id == $user->id ) { echo "selected"; } ?>><?php echo $user->name; ?></option>
                                          <?php } } ?>
                                          </select>
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                               ...
                               <input id="amount" name="amount" type="text" value="<?php echo $amount;?>" class="form-control" placeholder="Enter Amount"  />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                               ...
                               <input id="pdate" name="pdate" type="text" value="<?php echo date("F d, Y",strtotime($pdate));?>" class="form-control" placeholder="Enter Date" autocomplete="off" />
...
jQuery(document).ready(function () {
	"use strict";
	$('#pdate').datepicker({ autoclose: true });

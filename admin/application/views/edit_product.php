                                ...
                                <div class="col-md-12">
                                            ...
                                            <select id="material_type" name="material_type" class="form-control">
                                                ...
                                                if ($allmaterial != '') {
                                                    foreach ($allmaterial as $cate_data) {
                                                        ?>
                                                        <option value="<?php echo $cate_data->id; ?>" <?php if ($cate_data->id == $material_type) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?php echo $cate_data->name; ?></option>
                                                <?php }
                                                } ?>
                                            </select>
                                                            ...
                                                            <select id="state_id<?php echo $i + 1; ?>" name="state_id[]" onchange="get_group(this.value,'<?php echo $i; ?>');" class="form-control">
                                                                ...
                                                                <?php if ($allstate != '') {
                                                                            foreach ($allstate as $stateshow) {
                                                                                ?>
                                                                        <option value="<?php echo $stateshow->id; ?>" <?php if ($addition_item[$i]->state_id == $stateshow->id) {
                                                                                                                                            echo "selected";
                                                                ...
                                                                <select id="city_id<?php echo $i + 1; ?>" name="city_id[]" class="form-control" onchange="get_area(this.value,'<?php echo $i; ?>');">
                                                                    ...
                                                                    <?php if ($allcity != '') {
                                                                                foreach ($allcity as $cityhow) {
                                                                                    ?>
                                                                            <option value="<?php echo $cityhow->id; ?>" <?php if ($addition_item[$i]->city_id == $cityhow->id) {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>><?php echo $cityhow->name; ?></option>
                                                                    <?php }
                                                                            } ?>
                                                                </select>
                                                            </span>
                                                                ...
                                                                <select id="area_id<?php echo $i + 1; ?>" name="area_id[]" class="form-control" onchange="get_pincode(this.value,'<?php echo $i; ?>');">
                                                                    ...
                                                                    <?php if ($allarea != '') {
                                                                                foreach ($allarea as $areahow) {
                                                                                    ?>
                                                                            <option value="<?php echo $areahow->id; ?>" <?php if ($addition_item[$i]->area_id == $areahow->id) {
                                                                                                                                            echo "selected";
                                                                                                                                        } ?>><?php echo $areahow->name; ?></option>
                                                                    <?php }
                                                                            } ?>
                                                                </select>
                                                            </span>
                                  ...
                                  <select id="pincode_id<?php echo $i + 1; ?>" name="pincode_id[]" class="form-control">
                                    ...
                                    <?php //if($allpincode !='')
                                            ...
                                            //     {
                                            ?>
                                    <option value="<?php //echo $pincodehow->id; 
                                                            ?>" <?php //if($addition_item[$i]->pincode_id == $pincodehow->id ) { echo "selected"; } 
                                                                        ?>><?php //echo $pincodehow->name; 
                                                                                                            ?></option>
                                    <?php //} } 
                                            ?>
                                  </select>
...
<script>
    $(document).ready(function() {
        ...
        $(add_button).click(function(e) {
            ...
            if (b < max_fields) {
                b++;
                $(wrapper).append('<div class="customer_records"><div class="row"><div class="col-md-4"><div class="form-group"><select id="state_id' + b + '" name="state_id1[]" onchange="get_group1(this.value,' + b + ');"  class="form-control"><option value="">Select State*</option><?php if ($allstate != '') {
                                                                                                                                                                                                                                                                                                foreach ($allstate as $stateshow) {   ?> <option value="<?php echo $stateshow->id; ?>"><?php echo $stateshow->name; ?></option>   <?php }

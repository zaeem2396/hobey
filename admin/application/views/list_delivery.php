    ...
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          ...
          <li class="crumb-trail">Delivery Boy</li>
		  <li class="crumb-active"><a href="javascript:void(0);">Delivery Boy</a></li>
        </ol>
      </div>
    </div>
    <div id="content">
...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<a href="<?php echo $base_url;?>delivery/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Delivery Boy</a> 

      <a style="margin:0px 14px 0 0;" class="btn bg-purple2 pull-right"
                        href="<?php echo $base_url; ?>delivery/xlsuploaddelivery/">
                        <i class="fa fa-plus"></i> Upload Delivery Boys
                    </a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Delivery Boy Listing </span> </div>
            <div class="panel-body">
			  <form action="<?php echo $base_url."delivery/deletes";?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <td><?php echo $this->delivery_model->get_dist_name($result[$i]['distributor_id']); ?></td>
						 <td>

					<select title="Approve" id="change_status_<?php echo $result[$i]['id']; ?>" onchange="javascript:approve('<?php echo $base_url."delivery/updatestatus/"; ?><?php echo $result[$i]['id']; ?>',this.value,<?php echo $result[$i]['status']; ?>,<?php echo $result[$i]['id']; ?>);" >
                     ...
                     <td class="text-center"><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."delivery/edit/"; ?><?php echo $result[$i]['id'];?>">
...
function approve(url,is_active,oldVlaue,orderid){
  var box = document.getElementById('change_status_'+orderid);
		if(is_active=='0'){
		var t = confirm('Are you sure you want to Active delivery ?');	
			}
		else
		{
		var t = confirm('Are you sure you want to Deactive delivery  ?');
				}

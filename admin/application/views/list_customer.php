    ...
    <section id="content_wrapper">
        ...
        <div id="content">
            ...
            ?>
                ...
                <?php }  ?>
                <div class="col-md-12">
                    <form action="<?php echo $base_url."orders/download_customerorder";?>" method="post"
                        ...
                        <input type="hidden" value="<?php echo $user_id; ?>" id="user_id1" name="user_id">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo $base_url."orders/lists_customer";?>" method="post"
                                enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="user_id" name="user_id" class="form-control">
                                        ...
                                        <?php if($allcustomers !='')
                                             {
                                                foreach($allcustomers as $distributorshow)
                                                { ?>
                                        <option value="<?php echo $distributorshow->id; ?>"
                                            <?php if($user_id == $distributorshow->id ) { echo "selected"; } ?>>
                                ...
                                <div class="form-group col-md-1">
                                    <label for="inputEmail" style="visibility:hidden">&nbsp;</label><br>
                                    <a href="<?php echo $base_url;?>orders/lists_customer" class="submit btn bg-purple2"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo $base_url."orders/deleteOrders";?>" method="post"
                                       ...
                                       if($orders['paymentmode'] == '1'){  
                                       	...
                                       	echo 'Online Payment'; 
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else { ?> <span style="color:red;">Failed</span>
                                                    <?php } */?>
                                    	...
                                    	?> 
                                                ...
                                                <td class="text-center">
                                                    <a class="btn bg-purple2"
                                                        href="<?php echo $base_url.'orders/detail/'.$orders['order_id']?>"
                                                        title="Detail">

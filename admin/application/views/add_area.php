   ...
   <div id="topbar">
      <div class="topbar-left">
         <ol class="breadcrumb">
            ...
            <li class="crumb-active"><a href="javascript:void(0);"> Add Area</a></li>
         </ol>
      </div>
   </div>
   <div id="content">
      <div class="row" id="subform">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Add Area </span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12" >
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>area/add" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                               ...
                               <input id="name" name="name" type="text" class="form-control" placeholder="Enter Area Name" value=""/>

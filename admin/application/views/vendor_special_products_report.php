                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form action="<?php echo $base_url."reports_management/vendor_special_report";?>" method="post"
                                    ...
                                    <div class="form-group col-md-1">
                                        <label for="inputEmail" style="visibility:hidden">&nbsp;</label><br>
                                        <a href="<?php echo $base_url;?>reports_management/vendor_special_report" class="submit btn bg-purple2"

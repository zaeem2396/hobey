                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form action="<?php echo $base_url."reports_management/distributor_special_report";?>" method="post"
                                            ...
                                            <?php if($allSpProducts !='')
                                             {
                                                ...
                                                { ?>
                                                   <option value="<?php echo $productshow->id; ?>" <?php if($product_id == $productshow->id ) { echo "selected"; } ?>><?php echo $productshow->material_name; ?></option>
                                             <?php } } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-1">
                                        <label for="inputEmail" style="visibility:hidden">&nbsp;</label><br>
                                        <a href="<?php echo $base_url;?>reports_management/distributor_special_report" class="submit btn bg-purple2"

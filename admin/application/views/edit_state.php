  ...
  <section id="content_wrapper">
   ...
   <div id="content">
      <div class="row">
         <div class="col-md-12">
            <div class="panel">
               <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit State</span> </div>
               <div class="panel-body">
                  ...
                  <div class="col-md-12">
                     <form role="form" id="form" method="post" action="<?php echo $base_url;?>state/edit/<?php echo $id; ?>" enctype="multipart/form-data" >
                        ...
                        <INPUT TYPE="hidden" NAME="hiddenaction" VALUE="<?php echo $id;?>">
                           ...
                           <div class="form-group">
                              ...
                              <input id="name" name="name" type="text" class="form-control" placeholder="Enter State" value="<?php echo $name; ?>"/>
